...
To reproduce figures based on simulation results stored in `src/hpc-data` directory, 
the easiest way is:  
...
- Done! You are ready to run Julia scripts in this repository!
...
```
- Run `run-simulation-network.jl` in the container, passing parameter values of your choice.
